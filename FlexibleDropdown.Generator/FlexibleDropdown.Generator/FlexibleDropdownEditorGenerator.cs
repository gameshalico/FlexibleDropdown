...
namespace FlexibleDropdown.Generator
{
    ...
    public class FlexibleDropdownEditorGenerator : IIncrementalGenerator
    {
        ...
        private static void Execute(Compilation compilation, ImmutableArray<AttributeClassInfo?> classes, SourceProductionContext context)
        {
        ...
        private static string GenerateDrawerClass(AttributeClassInfo classInfo)
        {
            ...
            var source = $$"""
                ...
                {
                    [global::UnityEditor.CustomPropertyDrawer(typeof(global::{{classInfo.Namespace}}.{{classInfo.ClassName}}))]
                    public sealed class {{classInfo.ClassName}}Drawer : global::FlexibleDropdown.Editor.{{baseClass}}<global::{{classInfo.Namespace}}.{{classInfo.ClassName}}, {{classInfo.ValueType}}>
                    {
                    }
                }
                #endif
